...
#Проверка таблицы vine_geo, если в vine_target_all появлется новый целевой рестик, то необходимо добавить к нему координаты, эта отбивка прилетает на почту
